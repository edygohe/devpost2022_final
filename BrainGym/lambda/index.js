...
// Intent inicial de la skill - welcome
    ...
    canHandle(handlerInput) {
        ...
        return request.type === 'LaunchRequest'
            || (request.type === 'IntentRequest'
                && request.intent.name === 'IntroIntentHandler');
    },
    handle(handlerInput) {
		const sessionAttributes = handlerInput.attributesManager.getSessionAttributes();
        sessionAttributes.primera_vez = true;
        handlerInput.attributesManager.setSessionAttributes(sessionAttributes);
	
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();

        const imageTitle = requestAttributes.t('INTRO_TITLE_IMAGE');
        const imageDescription = requestAttributes.t('INTRO_DESC_IMAGE');
        

        // El siguiente valor es insertado en el SSML antes de ser enviado al APL response
        const ssml = requestAttributes.t('WELCOME_MSG');
        
        let audio = '';
        let bgImage = '';

        // Agregando directiva APL para response
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
            ...
            handlerInput.responseBuilder
                .addDirective({
                    ...
                    "document": {
                        "type":"Link",
                        "src":  "doc://alexa/apl/documents/catrina_00_v"
                    },
                    "datasources": {
                        "myData": {
                            "bgImage": requestAttributes.t('IMAGES_URLS'),
        ...
        return handlerInput.responseBuilder
            .addDirective({
                ...
                "document": {
                    "type":"Link",
                    "src":  "doc://alexa/apla/documents/catrina_00_a"
                },
                "datasources": {
                    "myData": {
                        "ssml": ssml,
                        "audio": requestAttributes.t('MUSIC_URLS'),
                        "volume":"30%",
                        "trim_end": 12000
                    }
                }
            ...
            //.withSimpleCard(requestAttributes.t('WITH_CARD_1'), requestAttributes.t('INTRO_DESC_IMAGE'))
            .getResponse();
    },
};

const MemoramaRequest = {
  canHandle(handlerInput) {
    ...
    return Alexa.isNewSession(handlerInput.requestEnvelope) 
      || Alexa.getRequestType(handlerInput.requestEnvelope) === 'MemoramaIntentHanler';
  },
  async handle(handlerInput) {
    ...
    // Agregando directiva APL para response
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
            // Video aleatorio
           // urlVideo = getRandomVideo(handlerInput);
            ...
            return handlerInput.responseBuilder
                .addDirective({
                    ...
                    "document": {
                        "type":"Link",
                        "src":  "doc://alexa/apl/documents/BGymLaunchRequest_Video"
                    },
                    "datasources": {
                        "myDataVideo": {
                            "urlVideo": 'https://braingym.s3.amazonaws.com/Resources/videos/LaunchRequest.mp4',
                            "subTitles": subTitles,
                            "ssml": ssml,
                            "audio": 'https://catrina-skill.s3.amazonaws.com/music/La+llorona.mp3'//requestAttributes.t('MUSIC_URLS')
                        }
                    }
                })
                .addDirective({
